...
import { Newspaper, Pencil, Users } from "lucide-react";
...
export default async function ProfilePage({
  ...
  return (
    <div className="bg-[url('/users/profile-bg.png')] px-8 py-16 bg-no-repeat bg-cover flex items-center gap-5 text-white md:p-10 md:py-14 md:px-40 lg:py-14">
