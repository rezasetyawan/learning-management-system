...
interface DiscussionsNavigationProps {
  academyId: string;
  moduleId: string;
}
export default function DiscussionsNavigation({
  academyId,
  moduleId,
}: DiscussionsNavigationProps) {
  return (
    <div className="p-2.5 absolute top-[10%] left-0 bg-white border rounded-r-lg max-lg:hidden">
      <Link href={`/admin/academies/${academyId}/discussions?moduleId=${moduleId}`}>
        <svg
          width="20"
          height="20"
          viewBox="0 0 54 54"
