  ...
  return displayQuizzResult && currentQuizzResult?.answers ? (
    ...
    <>
      ...
      <div className="relative">
        <Link
          href={`/admin/academies/${academyId}/module-groups/${currentModule.academyModuleGroupId}/modules/${currentModule.id}`}
          className="absolute left-4 top-4 z-[100]"
        >
            ...
            currentModule.quizz !== undefined ? (
              <div>
                <div className="flex justify-end">
                  <Link
                    href={`/admin/academies/${academyId}/module-groups/${moduleGroupId}/modules/${currentModule.id}/preview/quizz`}
                  >
        ...
        <div className="bg-white px-3 border h-16 fixed left-0 right-0 bottom-0 w-screen grid grid-cols-12 z-[1000] lg:px-10">
          {prevModule && (
            <div className="col-start-1 col-end-3 flex items-center justify-start md:col-end-5">
              <Link
                href={`/admin/academies/${academyId}/module-groups/${currentModuleGroup.id}/modules/${prevModule.id}/preview`}
          ...
          {nextModule && (
            <div className="col-start-11 col-end-13 flex items-center justify-end w-full md:col-start-9">
              <Link
                href={`/admin/academies/${academyId}/module-groups/${currentModuleGroup.id}/modules/${nextModule.id}/preview`}
                className="flex items-center w-4/5 lg:w-3/5"
                onClick={() =>
                  updateUserLastReadedModule(
                    academyId,
