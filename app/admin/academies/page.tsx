                ...
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="line-clamp-3 text-sm">
                      {academy.description || "Tidak ada deskripsi"}
                    </p>
                  </div>
                </div>

                <div className="mt-2 sm:flex items-center gap-2 max-sm:space-y-1.5">
                  <Badge
                    className={cn(
                      "bg-slate-500",
                      academy.isPublished && "bg-sky-700"
                    )}
                  >
                  ...
                  <p className="text-xs">
                    Dibuat pada: {formatTimestampToShortDate(academy.createdAt)}
                  </p>
                  <p className="text-xs">
                    Terakhir diubah:{" "}
                    {formatTimestampToShortDate(academy.updatedAt)}
                  </p>
                </div>
              </Link>
            );
