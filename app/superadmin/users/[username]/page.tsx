...
import UserRoleSelection from "./components/user-role-selection";
...
export default async function ProfilePage({
  ...
  return (
    <>
      ...
      <div className="bg-[url('/users/profile-bg.png')] px-8 py-16 bg-no-repeat bg-cover md:flex items-center gap-5 text-white md:p-10 md:py-14 md:px-10 lg:py-14">
        <div className="relative w-40 h-40">
          ...
          {isUserValid && currentUserId === userProfile.id ? (
            <Link
              ...
              className="block bg-white rounded-full border absolute bottom-3 right-1 p-1.5"
            >
        ...
        <div className="max-md:mt-2">
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <p>Bergabung pada {formatTimestamp(userProfile.createdAt)}</p>
          </div>
          <div className="mt-1 flex items-center gap-2">
            <svg
              width="16"
            ...
            <p>Terakhir diubah pada {formatTimestamp(userProfile.updatedAt)}</p>
          </div>
          <div className="mt-5">
            <h2 className="text-sm font-medium mb-2">Role Pengguna</h2>
